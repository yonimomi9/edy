...
import styles from "./PreviewMovieAdmin.module.css";
import { FaPlay, FaInfoCircle } from "react-icons/fa";
import { useNavigate } from "react-router-dom";

const PreviewMovieAdmin = ({ movies }) => {
  ...
  const handleMovieInfo = () => {
    if (previewMovie && previewMovie.id) {
      ...
      navigate(`/movie-info-admin?id=${previewMovie.id}`);
    }
  };
...
export default PreviewMovieAdmin;
