...
const MoviesPage = ({ isDarkMode, toggleTheme, loggedUser, allMovies = [], categories = [] }) => {
  ...
  console.log("All Movies in MoviesPage:", allMovies);
  console.log("Categories in MoviesPage (raw):", categories);
    ...
    <div className={styles.moviesPage}>
      ...
      <div className={styles.previewMovie}>
        ...
        {selectedPreviewMovie && selectedPreviewMovie.filePath ? (
          <PreviewMovie movies={[selectedPreviewMovie]} />
        ) : (
