...
import RecommendedMoviesAdmin from "../../Components/ComponentsAdmin/RecommendedMoviesAdmin/RecommendedMoviesAdmin";
import styles from "./MovieInfoAdmin.module.css";

const MovieInfoAdmin = ({ isDarkMode, toggleTheme, movies, categories, loggedUser }) => {
    ...
    return (
      <div className={styles.movieInfoContainer}>
        <NavbarAdmin
          ...
          userName={loggedUser?.nameForDisplay || "Admin"}
  ...
  return (
    <div className={styles.movieInfoContainer}>
      ...
      <div className={styles.bottomSection}>
        <RecommendedMoviesAdmin movies={recommendedMovies || []} />
      </div>
    </div>
  );
};

export default MovieInfoAdmin;
